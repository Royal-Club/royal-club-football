...
@Slf4j
public class TeamLogoR2StorageProvider implements TeamLogoStorageProvider {
    ...
    public TeamLogoR2StorageProvider(String endpoint,
                                     String bucket,
                                     String accessKey,
                                     String secretKey,
                                     long presignMinutes) {
    ...
    public InputStream load(String key) throws IOException {
        try {
            ...
            throw new IOException("Failed to load logo", ex);
        }
    }
    ...
    public void delete(String key) {
        try {
            ...
            log.warn("Failed to delete team logo key={}: {}", key, ex.getMessage());
        }
    }
