...
public class ResourceFileLocalStorageProvider implements ResourceFileStorageProvider {

    private final Path uploadPath;
    private final String baseUrl;

    public ResourceFileLocalStorageProvider(String uploadDir, String baseUrl) {
    ...
    public TeamLogoUploadResponse generateUploadUrl(String fileName, String contentType) {
        ...
        return TeamLogoUploadResponse.builder()
                ...
                .uploadUrl(baseUrl + "/files/resources/local/" + key)
