package com.bjit.royalclub.royalclubfootball.storage.teamlogo;
...
public class TeamLogoLocalStorageProvider implements TeamLogoStorageProvider {

    private final Path uploadPath;
    private final String baseUrl;

    public TeamLogoLocalStorageProvider(String uploadDir, String baseUrl) {
    ...
    public TeamLogoUploadResponse generateUploadUrl(String fileName, String contentType) {
        String key = "team-logo-" + UUID.randomUUID() + getSafeExtension(fileName);
        return TeamLogoUploadResponse.builder()
                .key(key)
                .url("/files/team-logos/" + key)
                .uploadUrl(baseUrl + "/files/team-logos/local/" + key)
    ...
    public void delete(String key) {
        try {
            ...
            // Swallow delete errors to avoid breaking business flow.
        }
    }
