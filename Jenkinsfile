pipeline {
    ...
    environment {
        ...
        TEAM_LOGO_R2_ENDPOINT       = credentials('TEAM_LOGO_R2_ENDPOINT')
        TEAM_LOGO_R2_ACCESS_KEY     = credentials('TEAM_LOGO_R2_ACCESS_KEY')
        TEAM_LOGO_R2_SECRET_KEY     = credentials('TEAM_LOGO_R2_SECRET_KEY')
        TEAM_LOGO_R2_BUCKET         = credentials('TEAM_LOGO_R2_BUCKET')
    }
